...
Small, unofficial Node client for ESPN's NBA data. ESPN serves NBA
under `basketball/nba`, and this wraps those endpoints.

Part of the [espn-api](https://github.com/LeSingh1/espn-api) family. The parent
repo is one client for every sport. This one is just NBA, in the style of
...
cd nba-api
node examples/scoreboard.js   # NBA games on the board
